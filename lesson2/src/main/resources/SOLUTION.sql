insert into student (name, birthday, groupnumber) values ('John', '2001-2-12', 5378);
insert into student (name, birthday, groupnumber) values ('Chris', '2001-7-12', 5378);
insert into student (name, birthday, groupnumber) values ('Carl', '2001-6-22', 5373);
insert into student (name, birthday, groupnumber) values ('Oliver', '2000-3-12', 4478);
insert into student (name, birthday, groupnumber) values ('James', '2000-5-12', 4478);
insert into student (name, birthday, groupnumber) values ('Lucas', '2000-4-30', 4473);
insert into student (name, birthday, groupnumber) values ('Henry', '1999-11-10', 4472);
insert into student (name, birthday, groupnumber) values ('Jacob', '1999-1-1', 3978);
insert into student (name, birthday, groupnumber) values ('Logan', '1998-12-12', 3978);
insert into student (name, birthday, groupnumber) values ('Marie', '1997-10-12', 2645);
insert into student (name, birthday, groupnumber) values ('Fletcher', '1998-8-12', 2546);
insert into student (name, birthday, groupnumber) values ('Marlo', '1997-9-12', 1328);
